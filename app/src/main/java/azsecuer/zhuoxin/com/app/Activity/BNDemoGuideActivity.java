...
public class BNDemoGuideActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		BaiduFragment.activityList.add(this);
		createHandler();
		...
		if (intent != null) {
			...
			if (bundle != null) {
				mBNRoutePlanNode = (BNRoutePlanNode) bundle.getSerializable(BaiduFragment.ROUTE_PLAN_NODE);
			}
		}
		//显示自定义图标
		if (hd != null) {
	...
	protected void onDestroy() {
		...
		BaiduFragment.activityList.remove(this);
